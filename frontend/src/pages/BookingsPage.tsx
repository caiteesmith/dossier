          ...
          <Card>
            <div className="stagger-children">
              {sorted.map((booking, i) => {
                ...
                console.log('weddingDate:', booking.weddingDate, typeof booking.weddingDate)
console.log('parsed date:', parseLocalDate(booking.weddingDate).toDateString())
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 50 }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '24px', maxWidth: '360px', width: '90%', boxShadow: '0 20px 60px rgba(0,0,0,0.2)' }}>
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                onClick={() => { deleteBooking.mutate(confirmDelete); setConfirmDelete(null) }}
